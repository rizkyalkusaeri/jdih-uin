    ...
    <div class="bg-white border-b border-gray-100 py-8">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav class="flex text-sm text-gray-500 mb-4">
          ...
          <span class="mx-2 text-gray-300">/</span>
          <span class="text-[#0F213A] font-medium">FAQ</span>
        </nav>
        <h1 class="text-3xl font-extrabold text-[#0F213A]">Frequently Asked Questions</h1>
      </div>
    </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="space-y-4">
              <div v-for="(faq, index) in faqs" :key="index"
                ...
                <button @click="toggleFaq(index)"
                  ...
                  <span class="font-bold text-[#0F213A] text-lg pr-8">{{ faq.question }}</span>
                  <div
                    class="w-8 h-8 rounded-full bg-gray-50 flex items-center justify-center shrink-0 transition-colors"
                    :class="{ 'bg-yellow-50 text-yellow-600': faq.isOpen }">
          ...
          <div class="lg:w-1/3 space-y-8">
            <!-- Kontak Kami Widget -->
            <div class="bg-[#0F213A] text-white p-8 rounded-2xl text-center shadow-lg top-24">
              ...
              <div class="mt-8 pt-8 border-t border-gray-700/50">
                <p class="text-xs text-gray-500 uppercase tracking-widest font-bold mb-4">Atau hubungi via</p>
